...
> [!NOTE]
> using [MPLAB X IDE v6.25](https://www.microchip.com/en-us/tools-resources/develop/mplab-x-ide) instead of Atmel-Studio 7.0 requests an additional compiler for some projects:<br>
